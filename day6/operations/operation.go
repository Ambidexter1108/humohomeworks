...
func TakeOrder(client customer.Patient) customer.Patient {
...
func BeginOperation(client customer.Patient) customer.Patient {
	var (
...
func Operation(client customer.Patient) customer.Patient {
	switch {
